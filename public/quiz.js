document.getElementById("result").innerHTML = "<i>Welcome To The Html Quiz <br/> Total Questions: 10 <br/><b> NOTE:</b>Not selected would be count as wrong"
...
function myfunction(){
    ...
    document.getElementById("result").innerHTML ="correct answers:" + correctAnswer + "<br/> Wrong Answers:"+ wrongAnswer + "<br/>Your total score is " + num  ;        
    }
    // console.log(num)
